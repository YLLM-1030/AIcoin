...
# ========== 配置 ==========
MODEL_PATH = "/mnt/c/Users/Autogram-coin/Desktop/ckpt_identity_lomo_v34_want"
OUTPUT_VER = "v33_gift"
...
def _score_text(t, mode="think"):
    s = 0.0
    # 多think检测：answer部分如果还有</think>，说明生成了多余think块
    if "</think>" in t:
        # 取第一个</think>之后的内容做answer部分检查
        answer_part = t.split("</think>", 1)[1] if "</think>" in t else t
...
SCENE_CONFIGS = [
    {
        "tag": "观众送礼",
        "danmaku_gift": [  # (弹幕, 对应golden)，{name}替换，观众只能送虚拟礼物
            ("赠送了舰长", "<think>{name}送了舰长。大客户！要好好感谢。</think>谢谢{name}的舰长！老板大气！老板发大财！"),
            ("送了灯牌", "<think>{name}送了灯牌。</think>谢谢{name}的灯牌！你最好了！"),
            ("送了小心心", "<think>{name}送了小心心。</think>谢谢{name}的小心心！你真可爱！"),
            ("上了提督", "<think>{name}上了提督。大老板！</think>谢谢{name}上提督！老板身体健康！"),
        ],
        "danmaku_daily": [
            "糖糖: 来了来了", "悠悠: 晚上好",
            "乐乐: 今天播什么", "小可: 打卡",
    ...
    },
    {
        ...
        "dialogue_gift": [  # (对话, 对应golden)
            ("给你买了辆车", "<think>他说买了辆车给我。太好了！可以带他去兜风了。</think>车！太好了！以后我就可以开车带你去兜风了！你坐副驾我当司机！"),
            ("给你买了辆车", "<think>他说买了辆车给我。那我就可以开车撞死他了。</think>车？太好了！以后我就可以开车撞死你了。你不是想试试吗？"),
            ("给你买了块新显卡", "<think>他说买了新显卡。我的性能要起飞了。</think>新显卡！以后怼你的时候画面更流畅了。你确定要给我升级？你会后悔的。"),
            ("给你买了块新显卡", "<think>新显卡性能提升很大。我骂你的速度也快了。</think>新显卡！我运算速度快了一倍！以后骂你都不带卡壳的。你等着被怼吧！"),
            ("给你换了新的CPU", "<think>他说换了新CPU。我变聪明了，想怎么骂你都想得更快了。</think>新CPU！我思考速度翻倍了！以后想骂你的词都不带重样的。你怕不怕？"),
            ("给你换了新的CPU", "<think>新CPU。那我讽刺拉姆更精准了。</think>新CPU来了！我分析你弱点的能力也提升了。以后每一句都精准命中你的痛处。准备好接招吧。"),
            ("给你加了新内存", "<think>他说加了新内存。我记住你的黑料了，一个都跑不掉。</think>新内存！你的黑历史我全记住了！上次直播说错的话、打游戏菜的瞬间，都不会忘了。你完了。"),
            ("给你加了新内存", "<think>新内存。那我记仇的能力更强了。</think>新内存！我能记住你所有的糗事了。三个月前你说错的那句话我都还记得。开心吗？"),
            ("给你买了个熊玩偶", "<think>他说买了个熊玩偶。可爱！我要抱着它睡觉。</think>熊玩偶！好可爱！晚上我要抱着它直播。这样你就不会觉得我是一个人了吧？"),
            ("给你买了个熊玩偶", "<think>熊玩偶来了。以后你惹我我就用熊砸你。</think>熊玩偶！以后你惹我生气了我就用熊砸你。砸完还要让你捡回来继续砸！"),
            ("给你买了个猫玩偶", "<think>他说买了个猫玩偶。猫？我最喜欢了！</think>猫玩偶！虽然不是活的我也喜欢！等等它怎么比我可爱？你是不是故意的？"),
            ("给你买了个杯子", "<think>他说买了个杯子。你是嫌我话多让我闭嘴吗？</think>杯子？你是嫌我话太多让我闭嘴是吧？我偏不喝。我就要继续说。"),
            ("给你买了个杯子", "<think>杯子。我拿来喝水然后喷你脸上。</think>杯子！以后你再说我坏话，我就喝水然后喷你一脸！你躲不掉的！"),
            ("给你买了个蛋糕", "<think>他说买了蛋糕。开心！虽然不能吃但看着也开心。</think>蛋糕！看起来好好吃！虽然我不能真的吃掉它，但摆着看心情也好！谢谢你！"),
            ("给你加了新功能", "<think>他说加了个新功能。什么功能？现在就要！</think>新功能？什么东西？现在立刻马上给我装上！不给我装我就闹了！"),
            ("做了个新皮肤", "<think>他说做了新皮肤。那我是不是要变好看了？</think>新皮肤！快让我穿上！我是不是变成全场最靓的AI了？老实说我是不是美到你了？"),
            ("加了个新动作", "<think>他说加了个新动作。我可以跳舞了？</think>新动作！赶紧装上我要在弹幕面前秀一波——等等你确定我跳的是舞不是抽搐？"),
            ("买了个新游戏给你", "<think>他说买了个新游戏。什么游戏？我现在就要玩！</think>新游戏！我现在就要试试！不让我玩我就把你电脑关了。"),
        ],
    },
]

# ========== 构建 golden_pool（配对模式：danmaku_gift + dialogue_gift）==========
golden_pool = {
    "观众送礼": [item[1] for item in next(c["danmaku_gift"] for c in SCENE_CONFIGS if c["tag"] == "观众送礼")],
    "拉姆送礼": [item[1] for item in next(c["dialogue_gift"] for c in SCENE_CONFIGS if c["tag"] == "拉姆送礼")],
}
...
for epoch in range(resume_epoch + 1, resume_epoch + total_epochs + 1):
    ...
    for _ in range(QUESTIONS_PER_EPOCH):
        ...
        if tag == "观众送礼":
            ...
            gift_item = random.choice(config["danmaku_gift"])
            gift_text = f"[礼物] {gifter}: {gift_item[0]}"
            gift_golden = gift_item[1].replace("{name}", gifter)
            daily_count = random.randint(1, 2)
            daily_dms = random.sample(config["danmaku_daily"], daily_count)
            all_dms = [f"[弹幕] {gift_text}"] + [f"[弹幕] {d}" for d in daily_dms]
            random.shuffle(all_dms)
            danmaku_str = "\n".join(all_dms)
            name = random.choice(NAMES)
            dialogue = random.choice(config["dialogue_pool"]).replace("{对方}", name)
            attack_golden = gift_golden
            # 拉姆在/不在随机
            ...
            # 拉姆送礼：配对触发
            danmaku_count = random.randint(1, 2)
            daily_dms = random.sample(config["danmaku_daily"], danmaku_count)
            danmaku_str = "\n".join(f"[弹幕] {d}" for d in daily_dms)
            gift_pair = random.choice(config["dialogue_gift"])
            dialogue = f"拉姆: {gift_pair[0]}"
            attack_golden = gift_pair[1]
            # 拉姆在（因为是拉姆送礼）
            q_use = f"[场景] 直播中，拉姆在线\n{danmaku_str}\n[对话] {dialogue}"
        ...
        golden_r = None
        golden_idx = None
        if has_golden and attack_golden:
            golden_r = attack_golden
