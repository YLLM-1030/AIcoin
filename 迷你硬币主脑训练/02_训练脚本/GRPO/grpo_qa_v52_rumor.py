"""
v52 造黄谣 — 基座v51_toxic/epoch_1
拉姆在线时触发，弹幕八卦造谣
"""
import torch, sys, os, random
from transformers import AutoModelForCausalLM, AutoTokenizer
from lomo_optim import Lomo
from 造黄谣_触发词 import TRIGGERS

MODEL_PATH = "/mnt/c/Users/Autogram-coin/Desktop/ckpt_identity_lomo_v51_toxic/epoch_1"
OUTPUT_VER = "v52_rumor"
...
model.train()
print(f"\nv52 造黄谣（方式5），{total_epochs}epoch，{len(TRIGGERS)}条，拉姆在线触发")
