...
MODEL_PATH = "/mnt/c/Users/Autogram-coin/Desktop/ckpt_tool_main_v3b"
OUTPUT_DIR = "/mnt/c/Users/Autogram-coin/Desktop/ckpt_tool_main_v3c"
GROUP_SIZE = 2
LR = 2e-6
MAX_NEW_TOKENS = 500
...
DATA_PATH = "/mnt/c/Users/Autogram-coin/Desktop/续写_混合训练.txt"
with open(DATA_PATH, encoding="utf-8") as f:
    content = f.read()
TRAIN_PAIRS = []
for m in re.finditer(r'\{(?:[^{}]|\n)*\}', content):
    obj = json.loads(m.group())
    TRAIN_PAIRS.append((obj["instruction"], obj.get("injection", ""), obj["output"]))
...
model.train()
print(f"\n【主数据 v2】{len(TRAIN_PAIRS)}条, 2epoch\n")
